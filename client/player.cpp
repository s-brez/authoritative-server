...
constexpr float32 c_player_movement_speed = 9.0f;
constexpr float32 c_player_movement_speed_sq = c_player_movement_speed * c_player_movement_speed;
constexpr float32 c_player_jumping_speed = 4.0f;
constexpr float32 c_player_air_control = 1.0f;
...
void tick_player(	Player_Snapshot_State* player_snapshot_state,
	...
	if (is_grounded) {
		...
		// set ground value for camera positioning
		player_snapshot_state->ground = 0.0f;
